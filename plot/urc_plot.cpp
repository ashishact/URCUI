...
**  the "setup(...)Demo" functions of URC_Plot.                                                          **
**                                                                                                         **
**  In order to see a demo in action, call the respective "setup(...)Demo" function inside the             **
**  URC_Plot constructor. Alternatively you may call setupDemo(i) where i is the index of the demo       **
**  you want (for those, see URC_Plot constructor comments). All other functions here are merely a       **
...
URC_Plot::URC_Plot(QWidget *parent):
    QCustomPlot(parent)
{
    ...
    gradient.setColorAt(0,QColor(200,223,212,255));
    gradient.setColorAt(1,QColor(145,254,204,255));
    QBrush b = QBrush(QImage(":/images/plot/papertex.jpg"));
    customPlot->setBackground(b);
//    customPlot->axisRect()->setBackground(Qt::white);

//  setupDemo(0);
  //setupPlayground(customPlot);
  // 0:  setupQuadraticDemo(customPlot);
  // 1:  setupSimpleDemo(customPlot);
  // 2:  setupSincScatterDemo(customPlot);
  // 3:  setupScatterStyleDemo(customPlot);
  // 4:  setupScatterPixmapDemo(customPlot);
  // 5:  setupLineStyleDemo(customPlot);
  // 6:  setupDateDemo(customPlot);
  // 7:  setupTextureBrushDemo(customPlot);
  // 8:  setupMultiAxisDemo(customPlot);
  // 9:  setupLogarithmicDemo(customPlot);
  // 10: setupRealtimeDataDemo(customPlot);
  // 11: setupParametricCurveDemo(customPlot);
  // 12: setupBarChartDemo(customPlot);
  // 13: setupStatisticalDemo(customPlot);
  // 14: setupSimpleItemDemo(customPlot);
  // 15: setupItemDemo(customPlot);
  // 16: setupStyledDemo(customPlot);
  // 17: setupAdvancedAxesDemo(customPlot);
...
#if RemoveGraphCode
void URC_Plot::setupDemo(int demoIndex)
{
  switch (demoIndex)
  {
    case 0:  setupQuadraticDemo(customPlot); break;
    case 1:  setupSimpleDemo(customPlot); break;
    case 2:  setupSincScatterDemo(customPlot); break;
    case 3:  setupScatterStyleDemo(customPlot); break;
    case 4:  setupScatterPixmapDemo(customPlot); break;
    case 5:  setupLineStyleDemo(customPlot); break;
    case 6:  setupDateDemo(customPlot); break;
    case 7:  setupTextureBrushDemo(customPlot); break;
    case 8:  setupMultiAxisDemo(customPlot); break;
    case 9:  setupLogarithmicDemo(customPlot); break;
    case 10: setupRealtimeDataDemo(customPlot); break;
    case 11: setupParametricCurveDemo(customPlot); break;
    case 12: setupBarChartDemo(customPlot); break;
    case 13: setupStatisticalDemo(customPlot); break;
    case 14: setupSimpleItemDemo(customPlot); break;
    case 15: setupItemDemo(customPlot); break;
    case 16: setupStyledDemo(customPlot); break;
    case 17: setupAdvancedAxesDemo(customPlot); break;
  }
...
void URC_Plot::setupQuadraticDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupSimpleDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupSincScatterDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupScatterStyleDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupLineStyleDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupScatterPixmapDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupDateDemo(QCustomPlot *customPlot)
{
  demoName = "Date Demo";
...
void URC_Plot::setupTextureBrushDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupMultiAxisDemo(QCustomPlot *customPlot)
{
  ...
  customPlot->legend->setVisible(true);
  QFont legendFont = font();  // start out with URC_Plot's font..
...
void URC_Plot::setupLogarithmicDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupRealtimeDataDemo(QCustomPlot *customPlot)
{
  ...
  */
  ...
  // setup a timer that repeatedly calls URC_Plot::realtimeDataSlot:
  connect(&dataTimer, SIGNAL(timeout()), this, SLOT(realtimeDataSlot()));
  dataTimer.start(0); // Interval 0 means to refresh as fast as possible
}

void URC_Plot::setupParametricCurveDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupBarChartDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupStatisticalDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupSimpleItemDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupItemDemo(QCustomPlot *customPlot)
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
...
void URC_Plot::setupStyledDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::setupAdvancedAxesDemo(QCustomPlot *customPlot)
{
...
void URC_Plot::realtimeDataSlot()
{
...
//          QString("%1 FPS, Total Data points: %2")
//          .arg(frameCount/(key-lastFpsKey), 0, 'f', 0)
//          .arg(customPlot->graph(0)->data()->count())
//          , 0);
    lastFpsKey = key;
    frameCount = 0;
  }
...
void URC_Plot::setupPlayground(QCustomPlot *customPlot)
{
  Q_UNUSED(customPlot)
}
#endif
...
void URC_Plot::allScreenShots()
{
  ...
  if (currentDemoIndex < 17)
  {
    ...
    delete customPlot;
    customPlot = new QCustomPlot(ui->centralWidget);
...
void URC_Plot::setup_URC_vel_plot()
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
  QMessageBox::critical(this, "", "You're using Qt < 4.7, the realtime data demo needs functions that are available with Qt 4.7 to work properly");
#endif
...
void URC_Plot::URC_vel_data_update(float velx, float vely)
{
    // calculate two new data points:
  #if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
    double key = 0;
